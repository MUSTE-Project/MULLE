...
incomplete concrete TertiaLexI of TertiaLex = Cat ** open Structural,Lexicon,PrimaLex,SecundaLex in {
  lin
    ...
    tunica_N = Lexicon.shirt_N ;
    mater_N = Lexicon.mother_N2 ;
    lingua_N = Lexicon.language_N ;
    discere_V2 = Lexicon.learn_V2 ;
    novus_A = Lexicon.new_A ;
    pater_N = PrimaLex.pater_N ; -- Prima
    puer_N = Lexicon.boy_N ;
    malus_A = Lexicon.bad_A ;
    plenus_A = Lexicon.full_A ;
}