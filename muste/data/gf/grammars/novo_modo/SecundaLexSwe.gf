...
concrete SecundaLexSwe of SecundaLex = CatSwe ** SecundaLexI with (Structural=StructuralSwe), (Lexicon=LexiconSwe), (PrimaLex=PrimaLexSwe) ** open ParadigmsSwe,  ExtraSwe, (I=IrregSwe), (D=DictSwe), Prelude, NumeralSwe in {
  lin
