...
\begin{minipage}{\textwidth}
  \hspace{-50px}\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto]
    ...
    \draw[->] (s2) .. controls (12,-2) and (1,-2) .. (login) node [above,sloped,midway,pos=0.6] {SMLoginFailed} ;
    \draw[->] (s3) .. controls (15,-1) and (0,-1) .. (login) node [above,sloped,midway,pos=0.6] {SMLoginFailed} ;
    \draw[->] (s4) .. controls (18,0) and (-1,0) .. (login) node [above,sloped,midway,pos=0.6] {SMLoginFailed} ;
...
\begin{tikzpicture}
  ...
  \node[attribute] (sessionStarttime) [below left=1cm and 1cm of session] {Starttime} ;
  \node[entity] (lesson) [below=5cm of user] {Lesson} ;
  \node[attribute] (lessonName) [above left=1cm and 2cm of lesson] {\underline{Name}} ;
  \node[attribute] (lessonDescription) [below left=1cm and 2cm of lesson] {Description} ;
  \node[weak] (exercise) [below=5cm of lesson] {Exercise} ;
  \node[attribute] (exerciseTree) [below=2cm of exercise] {\underline{Tree}};
  ...
  \node[relationship] (lessonFinished) [below right=2cm and 1cm of user] {finished} ;
  \node[attribute] (lessonFinishedTime) [above right=1cm and 1cm of lessonFinished] {Time} ;
  ...
  \node[attribute] (exerciseFinishedTime) [right=1cm of exerciseFinished] {Time} ;
  \path
  % User attributes
