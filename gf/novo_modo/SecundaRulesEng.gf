...
concrete SecundaRulesEng of SecundaRules = CatEng ** SecundaRulesI with (Cat=CatEng),(Syntax=SyntaxEng),(PrimaRules=PrimaRulesEng) ** open (R=ResEng), Prelude, ParamX in {
  lincat CS = SS ;
  lin
    impS pron vp =
